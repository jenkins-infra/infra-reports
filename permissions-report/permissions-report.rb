...
def record_collaborator(repo_name, collaborator, permission)
  ...
  if permission != "READ" and collaborator != "jenkinsadmin" and collaborator != "rtyler" and collaborator != "kohsuke" and collaborator != "daniel-beck" and collaborator != "oleg-nenashev" then
